...
pencil = pygame.image.load('lab8and9/img/pencil.png')
...
bucket = pygame.image.load('lab8and9/img/bucket.png')
bucket = pygame.transform.scale(bucket, (75, 75))

eraser = pygame.image.load('lab8and9/img/eraser.png')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('lab8and9/img/figures.png')
figures = pygame.transform.scale(figures, (75, 75))

pallete = pygame.image.load('lab8and9/img/palette.png')
